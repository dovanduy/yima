...
class Helper {
    ...
    public static function transaction_description() {
        return array('card' => 'Nạp tiền bằng thẻ cào',
            'coupon' => 'Nạp tiền bằng Coupon');
    }

    public static function _trans_des($key) {
        $description = self::transaction_description();
        return isset($description[$key]) ? $description[$key] : $key;
    }
    ...
    public static function array_querystring_truncate($array, $keys) {
