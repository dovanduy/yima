<div class="span8 magu-listing" id="post">
    <div class="row-fluid">
        ...
        <div class ="toefl-test" id="toefl_<?php echo $post['id'] ?>">
                <ul>
                    <li><a target="_blank" href="<?php echo Yii::app()->request->hostInfo . Yii::app()->params['domain'] ?>toeic/reading/index/<?php echo $post['reading'] ?>/<?php echo $cid?>/<?php //echo $c_id?>"> Reading </a></li>
                    
                </ul>
                <ul>
                    <li><a target="_blank" href="<?php echo Yii::app()->request->hostInfo . Yii::app()->params['domain'] ?>toeic/listening/index/<?php echo $post['listening'] ?>/<?php echo $cid?>/<?php //echo $c_id?>"> Listening </a></li>
