                        ...
                        <tr>
                            ...
                            <td class="align-left">
                                <strong>Level: <strong><?php echo $v['level'] ?><br/>
                                        ...
                                        <td><a href="<?php echo Yii::app()->request->baseUrl; ?>/user/toeic_details/id/<?php echo $v['id'] ?>" class="btn btn-warning">Chi tiết</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
                                    </table>
