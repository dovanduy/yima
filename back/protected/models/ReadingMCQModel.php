...
class ReadingMCQModel extends CFormModel {
    ...
    public function update($args) {
        ...
        $sql = 'update yima_toefl_reading_mcq set ' . $custom . ' where id = :id';
        $command = Yii::app()->db->createCommand($sql);
    ...
    public function add($rid, $title, $choice1, $choice2, $choice3, $choice4, $content, $choice, $author, $time) {
        $sql = 'INSERT into yima_toefl_reading_mcq(rid,content,title,choice1,choice2,choice3,choice4,answer,author,date_added,last_modified)
