...
class ReadingIQModel extends CFormModel {
    ...
    public function update($args) {
        ...
        $sql = 'update yima_toefl_reading_iq set ' . $custom . ' where id = :id';
        $command = Yii::app()->db->createCommand($sql);
    ...
    public function add($rid, $title, $content,$answer, $author, $time) {
        $sql = 'INSERT into yima_toefl_reading_iq(rid,content,title,answer,author,date_added,last_modified)
            VALUES(:rid,:content,:title,:answer,:author,:date_added,:last_modified)';
        $command = Yii::app()->db->createCommand($sql);
