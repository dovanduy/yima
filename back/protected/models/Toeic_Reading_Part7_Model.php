...
class Toeic_Reading_Part7_Model {
    ...
    public function gets($args, $page = 1, $ppp = 20) {
        ...
        $sql = "SELECT *
                FROM yima_toeic_reading_part7 ktrp 
                WHERE 1
                $custom
    ...
    public function add($reading_id, $question, $img, $thumbnail, $content, $choice1, $choice2, $choice3, $choice4, $answer, $date_added) {
        $sql = "INSERT into yima_toeic_reading_part7(rid, question, img, thumbnail, content, choice1, choice2, choice3, choice4, answer, date_added) values (:reading_id, :question, :img, :thumbnail, :content, :choice1, :choice2, :choice3, :choice4, :answer, :date_added)";
        $command = Yii::app()->db->createCommand($sql);
    ...
    public function update($args) {
        ...
        $sql = 'update yima_toeic_reading_part7 set ' . $custom . ' where id = :id';
        $command = Yii::app()->db->createCommand($sql);
