...
class Listening_cqModel extends CFormModel {
    ...
    public function update($args) {
        ...
        $sql = 'update yima_toefl_listening_cq set ' . $custom . ' where id = :id';
        $command = Yii::app()->db->createCommand($sql);
    ...
    public function add($lid, $title, $content, $lsound, $date_added) {
        $sql = 'INSERT into yima_toefl_listening_cq(lid, title, content, lsound, date_added) VALUES(:lid, :title, :content, :lsound,:date_added)';
        $command = Yii::app()->db->createCommand($sql);
        $command->bindParam(':lid', $lid, PDO::PARAM_INT);
