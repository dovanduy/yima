...
class ListeningSCQModel extends CFormModel {
    ...
    public function update($args) {
        ...
        $sql = 'update yima_toefl_listening_scq set ' . $custom . ' where id = :id';
        $command = Yii::app()->db->createCommand($sql);
    ...
    public function add($lid, $title, $choice1, $choice2, $choice3, $choice4, $choice,$form,$to, $sound1, $sound2, $sound3, $replay, $sentence, $author, $time) {
        $sql = 'INSERT into yima_toefl_listening_scq(lid,title,lsound, choice1,choice2,choice3,choice4,answer,replay,replay_from,replay_to,replay_sound,sentence,sentence_sound,author,date_added,last_modified)
      ...
      public function get_all_listening_scq() {
