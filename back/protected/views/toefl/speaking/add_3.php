...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toefl/speaking/index/part/3">Integrated Task (L+R) 03</a> <span class="divider">/</span> </li>
    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toefl/speaking/index/part/3">Add</a> <span class="divider">/</span> </li>
...
<form class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" name="direction" class="input-xxlarge" value="<?php if (isset($_POST['title'])) echo $_POST['title']; ?>">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label">Sound</label>
