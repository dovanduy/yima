...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toefl/readingMCQ/index/?rid=<?php echo $rid ?>&part=<?php echo $part ?>">MCQ</a> <span class="divider">/</span> </li>
    <li class="active">Add Reading</li>
</ul>
<hr/>
<legend>Add Reading MCQ</legend>
