...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toeic/listening_part1/index/lid/<?php echo $li;?>">TOEIC Listening Part 1</a> <span class="divider">/</span> </li>
    <li class="active">Add</li>
</ul>
<hr/>
<legend>Add Listening Part 2 Test</legend>
