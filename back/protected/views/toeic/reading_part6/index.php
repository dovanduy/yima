...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toeic/reading_part6/index/rid/<?php echo $reading['id']; ?>"><?php echo $reading['title']; ?></a><span class="divider">/</span></li>
       <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/toeic/reading_part6/index/rid/<?php echo $reading['id']; ?>">Part 6</a></li>
</ul>
<hr/>
<p class="clearfix"><a href="<?php echo Yii::app()->request->baseUrl; ?>/toeic/reading_part6/add/rid/<?php echo $reading['id']; ?>" class="btn btn-primary pull-right">Add New</a></p>
...
<table class="table table-bordered table-striped table-center reading">
    ...
    <tbody>
        <?php if (count($reading_part6) < 1): ?>
            <tr>
                <td colspan="4" reading="align-center">No record</td>
            </tr>
        <?php endif; ?>
        <?php foreach ($reading_part6 as $r): ?>
            <tr>  
                ...
                <?php endif; ?>
                <td><a class="btn btn-small" href="<?php echo Yii::app()->request->baseUrl . "/toeic/reading_part6/edit/rid/" . $reading['id'] . "/id/" . $r['id']; ?>">Edit</a></td>
                <td><a class="btn btn-small btn-danger delete-row" href="<?php echo Yii::app()->request->baseUrl . "/toeic/reading_part6/delete/rid/" . $reading['id'] . "/id/" . $r['id']; ?>">Delete</a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
