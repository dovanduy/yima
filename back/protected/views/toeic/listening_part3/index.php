...
<hr/>
<p class="clearfix"><a href="<?php echo Yii::app()->request->baseUrl; ?>/toeic/listening_part3/add/lid/<?php echo $listening['id']; ?>" class="btn btn-primary pull-right">Add New</a></p>
...
<table class="table table-bordered table-striped table-center reading">
    ...
    <tbody>
        <?php if (count($listening_part3) < 1): ?>
            <tr>
                <td colspan="5" reading="align-center">No record</td>
            </tr>
        <?php endif; ?>
        <?php foreach ($listening_part3 as $l): ?>
            <tr>  
                ...
                <?php endif; ?>
                <td><a class="btn btn-small" href="<?php echo Yii::app()->request->baseUrl . "/toeic/listening_part3/edit/lid/" . $listening['id'] . "/id/" . $l['id']; ?>">Edit</a></td>
                <td><a class="btn btn-small btn-danger delete-row" href="<?php echo Yii::app()->request->baseUrl . "/toeic/listening_part3/delete/lid/" . $listening['id'] . "/id/" . $l['id']; ?>">Delete</a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
