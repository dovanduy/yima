...
<script>
    $().ready(function(){
        ...
        function play_video(replay, from_time, to_time, filename){
            ...
            if (replay==0){
                lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/listening/listening_page/<?php echo $listening['lsound']; ?>';
                $('#video_duration').val(<?php echo $listening['lsound_duration']; ?>);
                $('#current_video_duration').val(0);
            }else{
                lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/listening/replay_sound/scq/' + filename;
        ...
        function replay_sentence(){
            ...
            var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/listening/sentence_sound/scq/'+$('#question'+current_question+' .sentence_sound').val();
            $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
        ...
        function play_question(current_question){
            ...
            var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/listening/'+$('#question'+current_question+' .question_type').val()+'/'+$('#question'+current_question+' .lsound').val();
            $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
        ...
        function next_step(){			
            ...
            switch (current_question){
                case -2:
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/system/listening_change_volume.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    $('.systempage2').show();
                    break;
					
                case -1:
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/system/listening_direction1.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    $('.systempage1').show();
                    break;
            ...
            $('.button.end_section').click(function(){
                ...
                $.post(url,{scq_id:scq_id,scq_choice:scq_choice,mcq_id:mcq_id,mcq_choice:mcq_choice,cq_id:cq_id,cq_choice:cq_choice}, function() {
