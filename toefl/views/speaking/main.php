...
<div class="sound">
    <embed type="application/x-shockwave-flash" flashvars="audioUrl=<?php echo base_url(); ?>admin/data/sounds/system/speaking_direction_1.mp3&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>
</div>
...
<!-- SPEAKING 02 -->
<div class="video_part step step9" style="display: none;">
    <div class="video_image"><img src="<?php echo base_url(); ?>img/headset.jpg" height="200"/></div>
</div>
<div class="step step10 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking2['subject']; ?></p>
</div>
<div class="step step11 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking2['subject']; ?></p>
    <p class="preparation_time">Preparation Time: 15 seconds</p>
</div>
...
<!-- SPEAKING 03 -->
<div class="video_part step step15" style="display: none;">
    <div class="video_image"><img src="<?php echo base_url(); ?>img/headset.jpg" height="200"/></div>
</div>
<div class="video_part step step18" style="display: none;">
...
<div class="reading_part step step16" style="display: none;">
    <div class="bold italic">Directions:</div>
    <p><?php echo $speaking3['direction']; ?></p>
</div>
<div class="reading_part step step17" style="display: none;">
    <div class="bold italic">Directions:</div>
    <p><?php echo $speaking3['direction']; ?></p>
...
<div class="step step19 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking3['subject']; ?></p>
</div>
<div class="step step20 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking3['subject']; ?></p>
    <p class="preparation_time">Preparation Time: 30 seconds</p>
</div>
<div class="step step21 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking3['subject']; ?></p>
    <p class="preparation_time">Preparation Time: 30 seconds</p>
    <div class="center"><img src="<?php echo base_url(); ?>img/off.gif" alt=""/></div>
    <p class="sub_timer">00:00</p>
...
<div class="step step22 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking3['subject']; ?></p>
...
<!-- SPEAKING 04 -->
<div class="video_part step step24" style="display: none;">
    <div class="video_image"><img src="<?php echo base_url(); ?>img/headset.jpg" height="200"/></div>
</div>
<div class="video_part step step27" style="display: none;">
...
<div class="reading_part step step25" style="display: none;">
    <div class="bold italic">Directions:</div>
    <p><?php echo $speaking4['direction']; ?></p>
</div>
<div class="reading_part step step26" style="display: none;">
    <div class="bold italic">Directions:</div>
    <p><?php echo $speaking4['direction']; ?></p>
    <div class="bold italic reading_time">Reading Time: 45 seconds</div>
...
<div class="step step30 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking4['subject']; ?></p>
    <p class="preparation_time">Preparation Time: 30 seconds</p>
    <div class="center"><img src="<?php echo base_url(); ?>img/off.gif" alt=""/></div>
    <p class="sub_timer">00:00</p>
...
<div class="step step31 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking4['subject']; ?></p>
    <p class="preparation_time">Recording: 60 seconds</p>
</div>
<div class="step step32 testing_part" style="display: none;">
    <p class="subject"><?php echo $speaking4['subject']; ?></p>
    <p class="preparation_time">Recording: 60 seconds</p>
    <div class="center"><img src="<?php echo base_url(); ?>img/on.gif" alt=""/></div>
    <p class="sub_timer">00:00</p>
...
<div class="video_part step step34" style="display: none;">
...
<!-- SPEAKING 06 -->
<div class="video_part step step40" style="display: none;">
    <div class="video_image"><img src="<?php echo base_url(); ?>img/headset.jpg" height="200"/></div>
</div>
...
<div class="step step42 testing_part" style="display: none;">
...
<div class="step step47 end_speaking" style="display: none;">
    <p>This is the end of Speaking Section.</p>
</div>
<div class="step step48 end_speaking" style="display: none;">
...
<script>
    ...
    $().ready(function(){
        ...
        $('.button.next').click(function(){
            ...
            ssound_duration_arr[6]='<?php echo $speaking5['ssound_duration'] ?>';
            ...
            switch(current_question){
                case 2:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/system/speaking_direction_2.mp3';
                ...
                case 3:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp1.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;

                case 4:
                    run_timer(<?php echo $speaking1['ssound_duration'] ?>);
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[1];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 5:
                    prepare_recorder(1);
                    run_timer(3);
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/prepare_response.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 7:
                    run_timer(5);
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp_afterbeep.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 9:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp2.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 10:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[2];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    sendToFlash('recorder01').saveRecordedWAV();
                    console.log('recorder01');
                    break;
                ...
                case 15:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp3.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 16:
                    run_timer(4);
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/speaking_direction_reading.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');

                    sendToFlash('recorder02').saveRecordedWAV();
                    console.log('recorder02');
                    break;
                ...
                case 18:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+lsound_arr[3];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 19:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[3];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 24:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp4.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 27:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+lsound_arr[4];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 28:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[4];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 33:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp5.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 34:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+lsound_arr[5];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');

                    sendToFlash('recorder05').saveRecordedWAV();
                    console.log('recorder05');
                    break;

                case 35:
                    run_timer(<?php echo $speaking5['ssound_duration'] ?>);
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[5];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
                ...
                case 40:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>img/sound/sp6.mp3';
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                ...
                case 41:
                    ...
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+lsound_arr[6];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');

                    sendToFlash('recorder07').saveRecordedWAV();
                    console.log('recorder07');
                    break;

                case 42:
                    run_timer(<?php echo $speaking6['ssound_duration'] ?>);
                    var lsound='audioUrl=<?php echo base_url(); ?>admin/data/sounds/speaking/'+ssound_arr[6];
                    $('.sound').html('<embed type="application/x-shockwave-flash" flashvars="'+lsound+'&autoPlay=true" src="http://www.google.com/reader/ui/3523697345-audio-player.swf" width="400" height="0" quality="best"></embed>');
                    break;
