...
class Teacher extends CI_Controller {
    ...
    public function index($start = 0) {
        ...
        $config['total_rows'] = $this->Teacher_model->count_all_entries();
        ...
        $this->data['items'] = $this->Teacher_model->get_entries($start);
    ...
    public function add() {
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                ...
                $this->Teacher_model->insert_entry();
    ...
    public function edit($id = 0) {
        ...
        $this->data['id'] = $id;
        $item = $this->Teacher_model->get_entry($id);
        if (isset($item[0]))
        ...
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                $this->Teacher_model->update_entry();
    ...
    public function confirm_delete($id = 0) {
        ...
        $this->Teacher_model->delete_entry($id);
