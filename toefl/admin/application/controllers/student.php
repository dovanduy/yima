...
class Student extends CI_Controller {
    ...
    public function search() {
        ...
        $this->data['items'] = $this->Student_model->search_entries();
    ...
    public function index($start = 0) {
        ...
        $config['total_rows'] = $this->Student_model->count_all_entries();
        ...
        $this->data['items'] = $this->Student_model->get_entries($start);
    ...
    public function add() {
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                ...
                $this->Student_model->insert_entry();
    ...
    public function edit($id = 0) {
        ...
        $this->data['id'] = $id;
        $item = $this->Student_model->get_entry($id);
        if (isset($item[0]))
        ...
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                $this->Student_model->update_entry();
