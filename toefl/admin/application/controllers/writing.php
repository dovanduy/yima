...
class Writing extends CI_Controller {
    ...
    public function __construct() {
        ...
        //--- load part
        $part_name = array(1 => 'Integrated Writing', 2 => 'Independent Writing');
        $this->data['part'] = $this->session->userdata('part');
        if ($this->data['part']<=2) $this->data['part_name'] = $part_name[$this->session->userdata('part')];
    ...
    public function search() {
        ...
        $this->data['items'] = $this->Writing_model->search_entries();
    ...
    public function index($start = 0) {
        ...
        $config['total_rows'] = $this->Writing_model->count_all_entries();
        ...
        $this->data['items'] = $this->Writing_model->get_entries($start);
    ...
    public function add() {
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                ...
                $this->Writing_model->insert_entry();
    ...
    public function edit($id = 0) {
        ...
        $this->data['id'] = $id;
        $item = $this->Writing_model->get_entry($id);
        if (isset($item[0]))
        ...
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                $this->Writing_model->update_entry();
    ...
    public function confirm_delete($id = 0) {
        ...
        $this->Writing_model->delete_entry($id);
