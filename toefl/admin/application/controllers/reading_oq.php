...
class Reading_oq extends CI_Controller {
    ...
    public function __construct() {
        ...
        //--- load object model
        $this->load->model('Reading_oq_model');
    ...
    public function search() {
        ...
        $this->data['items'] = $this->Reading_oq_model->search_entries();
    ...
    public function index($start = 0) {
        ...
        $config['total_rows'] = $this->Reading_oq_model->count_all_entries();
        ...
        $this->data['items'] = $this->Reading_oq_model->get_entries($start);
    ...
    public function add() {
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                ...
                $this->Reading_oq_model->insert_entry();
    ...
    public function edit($id = 0) {
        ...
        $this->data['id'] = $id;
        $item = $this->Reading_oq_model->get_entry($id);
        if (isset($item[0]))
        ...
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                $this->Reading_oq_model->update_entry();
    ...
    public function confirm_delete($id = 0) {
        ...
        $this->Reading_oq_model->delete_entry($id);
