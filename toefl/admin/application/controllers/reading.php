...
class Reading extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->data['link_scq'] = base_url() . $this->object . '_scq/reading/';
        $this->data['link_mcq'] = base_url() . $this->object . '_mcq/reading/';
        $this->data['link_iq'] = base_url() . $this->object . '_iq/reading/';
        $this->data['link_ddq'] = base_url() . $this->object . '_ddq/reading/';
        $this->data['link_oq'] = base_url() . $this->object . '_oq/reading/';
        //--- end prepare links
    ...
    public function search() {
        ...
        $this->data['items'] = $this->Reading_model->search_entries();
    ...
    public function index($start = 0) {
        ...
        $config['total_rows'] = $this->Reading_model->count_all_entries();
        ...
        $this->data['items'] = $this->Reading_model->get_entries($start);
    ...
    public function add() {
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                ...
                $this->Reading_model->insert_entry();
    ...
    public function edit($id = 0) {
        ...
        $this->data['id'] = $id;
        $item = $this->Reading_model->get_entry($id);
        if (isset($item[0]))
        ...
        if (isset($_POST['title'])) {
            ...
            if ($message == '') {
                $this->Reading_model->update_entry();
    ...
    public function confirm_delete($id = 0) {
        ...
        $this->Reading_model->delete_entry($id);
