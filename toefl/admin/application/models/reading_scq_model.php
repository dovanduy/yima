...
class Reading_scq_model extends CI_Model {
    ...
    function count_all_entries() {
        ...
        $this->db->order_by("id", "asc");
        $this->db->order_by("title", "asc");
        return $this->db->count_all_results('reading_scq');
    }
    ...
    function get_entries($start = 0) {
        ...
        $this->db->order_by("id", "asc");
        $this->db->order_by("title", "asc");
        $query = $this->db->get('reading_scq', $per_page, $start);
        return $query->result();
    }
    ...
    function insert_entry() {
        ...
        $this->db->insert('reading_scq', $data);
    }
    ...
    function update_entry() {
        ...
        $this->db->update('reading_scq', $data, array('id' => $this->input->post('id')));
    }

    function delete_entry($id) {
        $data = array('deleted' => 1);
        $this->db->where('id', $id);
        $this->db->update('reading_scq', $data);
    }
