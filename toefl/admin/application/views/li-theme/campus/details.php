...
<section role="main">
    ...
    <ul id="breadcrumbs">
        ...
        <li><a href="<?php echo $link_object; ?>">Campus</a></li>
        ...
        <div class="article-container">
            ...
            <section>
                ...
                <form action="<?php echo $link_current; ?>" method="post">
                    ...
                    <fieldset>
                        <dl>
                            <dt><label>Campus Name</label></dt><dd><input class="medium" type="text" name="title" value="<?php if (isset($item->title)) echo $item->title; ?>"/></dd>
                        </dl>
                    </fieldset>
