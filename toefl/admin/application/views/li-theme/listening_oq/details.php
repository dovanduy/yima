...
<section role="main">
    ...
    <ul id="breadcrumbs">
        ...
        <li><a href="<?php echo $link_object; ?>">OQ</a></li>
                ...
                <form action="<?php echo $link_current; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <dl>
                            ...
                            <?php if (isset($item->lsound) && $item->lsound != '') { ?>
                                <dt><label>&nbsp;</label></dt><dd>
                                    ...
                                    <script type="text/javascript">
                                        jwplayer("lsound").setup({ flashplayer: "<?php echo theme_url(); ?>js/player.swf", file: "<?php echo base_url(); ?>data/sounds/listening/oq/<?php echo $item->lsound; ?>",
                                            height: 50,
                                            width: 250
                                        });
                                    </script>
                            ...
                            <?php } ?>
                            <dt><label>Choice 1</label></dt><dd><input class="medium" type="text" name="choice1" value="<?php if (isset($item->choice1))
                echo out_char($item->choice1); ?>"></dd>
                            <dt><label>Choice 2</label></dt><dd><input class="medium" type="text" name="choice2" value="<?php if (isset($item->choice2))
                echo out_char($item->choice2); ?>"></dd>
                            <dt><label>Choice 3</label></dt><dd><input class="medium" type="text" name="choice3" value="<?php if (isset($item->choice3))
                echo out_char($item->choice3); ?>"></dd>
                            <dt><label>Choice 4</label></dt><dd><input class="medium" type="text" name="choice4" value="<?php if (isset($item->choice4))
