                        ...
                        if (isset($items)) {
                            foreach ($items as $item) {
                                ...
                                <tr id="item<?php echo $item->id; ?>">
                                    ...
                                    <td><?php echo $item->count_iq; ?></td>
                                    <td><?php echo $item->count_ddq; ?></td>
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="edit" href="<?php echo $link_iq . $item->id; ?>">IQ</a>&nbsp;&nbsp;
                                        <a class="edit" href="<?php echo $link_ddq . $item->id; ?>">DDQ</a>&nbsp;&nbsp;
