...
<section role="main">
    ...
    <ul id="breadcrumbs">
        ...
        <li><a href="<?php echo $link_object; ?>">SCQ</a></li>
        ...
        <div class="article-container">
            ...
            <section>
                ...
                echo out_char($item->title); ?>"/></dd>
                            ...
                            <?php if (isset($item->lsound) && $item->lsound != '') { ?>
                                <dt><label>&nbsp;</label></dt><dd>
                                    ...
                                    <script type="text/javascript">
                                        jwplayer("lsound").setup({ flashplayer: "<?php echo theme_url(); ?>js/player.swf", file: "<?php echo base_url(); ?>data/sounds/listening/scq/<?php echo $item->lsound; ?>",
                                            height: 50,
                                            width: 250
                                        });
                                    </script>
                            ...
                            <?php } ?>
                            <dt><label>Choice 1&nbsp;&nbsp;&nbsp;<input type="radio" name="answer" value="1" <?php if (isset($item->answer) && $item->answer == 1)
                ...
                echo out_char($item->choice1); ?>"></dd>
                            <dt><label>Choice 2&nbsp;&nbsp;&nbsp;<input type="radio" name="answer" value="2" <?php if (isset($item->answer) && $item->answer == 2)
                ...
                echo out_char($item->choice2); ?>"></dd>
                            <dt><label>Choice 3&nbsp;&nbsp;&nbsp;<input type="radio" name="answer" value="3" <?php if (isset($item->answer) && $item->answer == 3)
                ...
                echo out_char($item->choice3); ?>"></dd>
                            <dt><label>Choice 4&nbsp;&nbsp;&nbsp;<input type="radio" name="answer" value="4" <?php if (isset($item->answer) && $item->answer == 4)
                ...
                echo out_char($item->choice4); ?>"></dd>
                    ...
                    <fieldset>
                        ...
                        <dl>
                            ...
                            <dt class="replay_div"><label>From</label></dt><dd class="replay_div"><input class="small" type="text" name="replay_from" value="<?php if (isset($item->replay_from)) echo $item->replay_from; ?>">&nbsp;&nbsp;&nbsp;second(s)</dd>
                            <dt class="replay_div"><label>To</label></dt><dd class="replay_div"><input class="small" type="text" name="replay_to" value="<?php if (isset($item->replay_to)) echo $item->replay_to; ?>">&nbsp;&nbsp;&nbsp;second(s)</dd>
                            ...
                            <?php if (isset($item->replay_sound) && $item->replay_sound != '') { ?>
                                <dt><label>&nbsp;</label></dt><dd>
                                    ...
                                    <script type="text/javascript">
                                        jwplayer("lsound").setup({ flashplayer: "<?php echo theme_url(); ?>js/player.swf", file: "<?php echo base_url(); ?>data/sounds/listening/replay_sound/scq/<?php echo $item->replay_sound; ?>",
                                            height: 50,
                                            width: 250
                                        });
                                    </script>
                        ...
                        <dl>
                            ...
                            <?php if (isset($item->sentence_sound) && $item->sentence_sound != '') { ?>
                                <dt><label>&nbsp;</label></dt><dd>
                                    ...
                                    <script type="text/javascript">
                                        jwplayer("lsound").setup({ flashplayer: "<?php echo theme_url(); ?>js/player.swf", file: "<?php echo base_url(); ?>data/sounds/listening/sentence_sound/scq/<?php echo $item->sentence_sound; ?>",
                                            height: 50,
                                            width: 250
                                        });
                                    </script>
