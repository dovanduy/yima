            ...
            <section>
                ...
                <form action="<?php echo $link_current; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <dl>
                            <dt><label>Subject</label></dt><dd style="padding-top: 5px; width: 450px;"><?php if (isset($item->subject)) echo $item->subject; ?></dd>
                            <dt><label></label></dt>
                            <dd>
                    ...
                    <fieldset class="field_direction" style="<?php if ($part == 1 || $part == 2 || $part == 5 || $part == 6) echo 'display: none;'; ?>">
                        ...
                        <dl>
                            <dt><label></label></dt><dd style="padding-top: 5px; width: 450px;"><?php if (isset($item->direction)) echo $item->direction; ?></dd>
                            <dt><label></label></dt><dd>
