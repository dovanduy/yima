                ...
                <form action="<?php echo $link_current; ?>" method="post">
                    ...
                    <fieldset>
                        <dl>
                            ...
                            <dt><label>Choice 1</label></dt><dd><input class="medium" type="text" name="choice1" value="<?php if (isset($item->choice1)) echo out_char($item->choice1); ?>"></dd>
                            <dt><label>Choice 2</label></dt><dd><input class="medium" type="text" name="choice2" value="<?php if (isset($item->choice2)) echo out_char($item->choice2); ?>"></dd>
                            <dt><label>Choice 3</label></dt><dd><input class="medium" type="text" name="choice3" value="<?php if (isset($item->choice3)) echo out_char($item->choice3); ?>"></dd>
                            <dt><label>Choice 4</label></dt><dd><input class="medium" type="text" name="choice4" value="<?php if (isset($item->choice4)) echo out_char($item->choice4); ?>"></dd>
