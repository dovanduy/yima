<div id="scq">
    <?php
    if (isset($listening_part4)) {
        //print_r();die;
        foreach ($listening_part4 as $row) {
            ?>
            <div class="question" id="question<?php echo $row['number_question'] ?>" style="display: none;">
                ...
                <div class="answer">
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="1"> <?php echo $row['choice1_1']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="2"> <?php echo $row['choice2_1']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="3"> <?php echo $row['choice3_1']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="4"> <?php echo $row['choice4_1']; ?></p>
                </div>
                ...
                <div class="answer">
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="1"> <?php echo $row['choice1_2']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="2"> <?php echo $row['choice2_2']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="3"> <?php echo $row['choice3_2']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="4"> <?php echo $row['choice4_2']; ?></p>
                </div>
                ...
                <div class="answer">
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="1"> <?php echo $row['choice1_3']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="2"> <?php echo $row['choice2_3']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="3"> <?php echo $row['choice3_3']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="4"> <?php echo $row['choice4_3']; ?></p>
                </div>
            </div>
            <?php
        }
