<div id="scq">
    <?php
    if (isset($listening_scq)) {
        foreach ($listening_scq as $row) {
            ?>
            <div class="question" id="question<?php echo $row['number_question'] ?>" style="display: none;">
                ...
                <div class="title"><?php echo $row['title']; ?> &nbsp;&nbsp;<?php if ($row['sentence'] == 1) echo '<img src="' . base_url() . 'img/replay.gif" alt="" style="border:none;"/>'; ?></div>
                <div class="answer">
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="1"> <?php echo $row['choice1']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="2"> <?php echo $row['choice2']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="3"> <?php echo $row['choice3']; ?></p>
                    <p><input type="radio" name="scq<?php echo $row['id']; ?>" value="4"> <?php echo $row['choice4']; ?></p>
                </div>
            </div>
            <?php
        }
