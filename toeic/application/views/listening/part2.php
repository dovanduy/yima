<div id="scq">
    <?php
    if (isset($listening_part2)) {
        //print_r();die;
        foreach ($listening_part2 as $row) {
            ?>
            <div class="question" id="question<?php echo $row['number_question'] ?>" style="display: none;">
                ...
                <div class="answer">
                    <p><input type="radio" name="part2_<?php echo $row['id']; ?>" value="1"> <?php echo $row['choice1']; ?></p>
                    <p><input type="radio" name="part2_<?php echo $row['id']; ?>" value="2"> <?php echo $row['choice2']; ?></p>
                    <p><input type="radio" name="part2_<?php echo $row['id']; ?>" value="3"> <?php echo $row['choice3']; ?></p>
                    <p><input type="radio" name="part2_<?php echo $row['id']; ?>" value="4"> <?php echo $row['choice4']; ?></p>
                </div>
            </div>
            <?php
        }
