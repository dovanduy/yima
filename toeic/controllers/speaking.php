...
class Speaking extends CI_Controller {
    ...
    private function get_speaking($sid) {
        $query = $this->db->query('SELECT * FROM ' . $this->db->dbprefix('kto_toefl_speaking') . ' where id=' . $sid);
            ...
            if ($row->ssound == '') {
                ...
                if (file_exists($f)) {
                    ...
                    if ($a['Encoding'] == 'Unknown') {
                        ...
                        $response['ssound_duration'] = intval($a['Length']) + 3;
                    }
                } else {
                    $response['ssound_duration'] = 3;
                }
            ...
            if ($row->dsound == '') {
                ...
                if (file_exists($f)) {
                    ...
                    if ($a['Encoding'] == 'Unknown') {
                        ...
                        $response['dsound_duration'] = intval($a['Length']) + 6;
                    }
                } else {
                    $response['dsound_duration'] = 6;
                }
            ...
            if ($row->introsound == '') {
                ...
                if (file_exists($f)) {
                    ...
                    if ($a['Encoding'] == 'Unknown') {
                        ...
                        $response['introsound_duration'] = intval($a['Length']) + 3;
                    }
                } else {
                    $response['introsound_duration'] = 3;
                }
