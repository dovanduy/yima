                                ...
                                <div class="span10 form-magu">
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="controls">
                                                <select name="subject" class="input-xxlarge span11">
                                                    ...
                                                    <?php foreach ($subjects as $k => $v): ?>
                                                        <option <?php if (isset($_POST['subject']) && $_POST['subject'] == $v['id']) echo 'selected'; ?> value="<?php echo $v['id']; ?>"><?php echo $v['title']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="controls">
                                                <select name="organization" class="input-xxlarge span11">
                                                    ...
                                                    <?php foreach ($organizations as $k => $v): ?>
                                                        <option <?php if (isset($_POST['organization']) && $_POST['organization'] == $v['id']) echo 'selected'; ?> value="<?php echo $v['id']; ?>"><?php echo $v['title']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls"><input maxlength="200" type="text" class="input-xlarge span11" name="title" value="<?php if (isset($_POST['title'])) echo htmlspecialchars($_POST['title']); ?>"></div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Nội dung câu hỏi<div class="required">*</div></label>
                                                <div class="controls">
                                                    <textarea cols="150" rows="15" name="content"><?php if (isset($_POST['content'])) echo $_POST['content']; ?></textarea>
                                                </div>         
